#!/usr/bin/env python3
"""
Qiaomu PPT - SVG Rounded Rectangle to Path Tool
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description='Qiaomu PPT - SVG Rounded Rectangle to Path Tool',
...
'''
    ...
    if not quiet:
        print("Qiaomu PPT - SVG Rounded Rectangle to Path Tool")
        print("=" * 50)
