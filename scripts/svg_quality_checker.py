#!/usr/bin/env python3
"""
Qiaomu PPT - SVG Quality Check Tool

Checks whether SVG files comply with project technical specifications.
This script provides a manual CLI with --help; argparse is intentionally not
required so the checker stays dependency-light for vendored use.
...
def print_usage() -> None:
    ...
    print("Qiaomu PPT - SVG Quality Check Tool\n")
    print("Usage:")
